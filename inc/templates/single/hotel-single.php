    ...
    <div class="tf-tour-single">
        <div class="tf-container">
            <div class="tf-container-inner">
                ...
                <?php
                if (file_exists(TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/places.php')) {
                    include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/places.php';
                }
                ?>
                ...
                if (!empty(Helper::tf_data_types(Helper::tfopt('tf-template'))['single-hotel-layout'])) {
                    foreach (Helper::tf_data_types(Helper::tfopt('tf-template'))['single-hotel-layout'] as $section) {
                        if (!empty($section['status']) && $section['status'] == "1" && !empty($section['slug'])) {
                            include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/' . $section['slug'] . '.php';
                        }
                    }
                } else {
                    include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/description.php';
                    include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/features.php';
                    include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/rooms.php';
                    include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/facilities.php';
                    include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/faq.php';
                    include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/review.php';
                    include TF_PACKAGE_TEMPLATE_PATH . 'single/hotel/trams-condition.php';
                }
                ?>
            </div>
