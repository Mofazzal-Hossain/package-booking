...
$selected_tours = !empty($tf_package_opt['tf_package_tours']) ? $tf_package_opt['tf_package_tours'] : [];
...
if ($query->have_posts()) :
    while ($query->have_posts()) : $query->the_post();
        ...
        $option_meta = get_post_meta(get_the_ID(), 'tf_tours_opt', true);
        ...
        $min_price_arr = Tour_Price::instance($post_id)->get_min_price();
            ...
            <div class="tf-item-content">
                <div class="tf-item-top-info">
                    ...
                    <h2 class="tf-item-title">
                        <a href="<?php echo esc_url(get_the_permalink()) ?>" class="tf-item-title-link">
                            <?php the_title(); ?>
                        </a>
                    </h2>
                </div>
                <div class="tf-item-bottom-info">
                    ...
                    <div class="tf-item-btn">
                        <button class="tf-btn tf-open-popup" data-post-id="<?php echo esc_attr(get_the_ID()); ?>" data-post-type="tf_tours">
